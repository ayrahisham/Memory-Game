...
import { Iconicons, FontAwesome, Entypo } from '@expo/vector-icons';
...
export default class App extends React.Component
{
    ...
    {
        super (props);
        // bond the functions to the class
        ...
        // add code creating clone and setting the cards in the state
        ...
        this.state =
        {
            current_selection : [], // this array contain an array of card objects which are currently selected by the user. This will contain 2 objects at a time.
            selected_pairs : [], // the name of the icons. This array is used for excluding them from further selection
    ...
    clickCard (id)
    {
        ...
        // the card shouldnt already be opened and is not on the array of cards whose pairs are already selected
        if (cards [index].is_open == false && selected_pairs.indexOf (cards [index].name === -1))
        {
            // add code for processing the selected card
            ...
            // add code for determiing whether the user has selected the correct pair or not
            ...
            // add code for updating the state
            this.setState (
                {
                    score : score,
                    cards : cards,
